...
import { Activity, CheckCircle2, Clock, Zap, ExternalLink } from 'lucide-react';
      ...
      <div className="space-y-4">
        {activities.map((act) => (
          <div
            ...
            className="p-5 rounded-2xl bg-[#12141d]/90 border border-white/5 hover:border-indigo-500/30 transition-all cursor-pointer flex flex-col md:flex-row items-start md:items-center justify-between gap-4 group"
          >
